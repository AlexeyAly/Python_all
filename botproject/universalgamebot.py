...
def send_echo(uiper):
    word = get_word()
    bot.send_message(uiper.chat.id, 'Давайте играть в угадайку слов!')
    ...
    if inp in guessed_letters:
        ...
        if inp.isalpha() == 0:
            ...
            if tries < 1:
                ...
                bot.send_message(message.chat.id, "Вы хотите сыграть еще (1 - да, 0 - нет): ")
...
def check_word2(message):
    bot.send_message(message.chat.id, 'пока все получается')
